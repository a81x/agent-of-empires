...
pub(super) struct RunnerShared {
    ...
    pub(super) pending_client_responses:
        Mutex<HashMap<i64, tokio::sync::oneshot::Sender<serde_json::Value>>>,
...
/// One maximum-sized ACP frame must fit, while a detached runner never retains unbounded data.
pub(super) const MAX_CONTROL_QUEUE: usize = 4096;
pub(super) const MAX_CONTROL_QUEUE_BYTES: usize = 128 * 1024 * 1024;
